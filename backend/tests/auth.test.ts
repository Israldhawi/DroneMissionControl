...
describe("Mission Rules - R-03", () => {
  ...
  it("R-03: rejects completing a future mission", () => {
  ...
  it("R-03: accepts completing a mission that has arrived", () => {
    const errors = validateFutureCompletion(
  ...
  it("R-03: accepts completing a past mission", () => {
    const errors = validateFutureCompletion(
  ...
  it("R-03: does not block a future mission when the requested status is not completed", () => {
    const errors = validateFutureCompletion(
      "2026-09-03T12:00:00Z",
      "in_progress",
      now,
...
describe("Mission Rules - R-01 and R-02", () => {
  it("R-01: accepts valid battery values", () => {
    const errors = validateBattery(80, 40);

    expect(errors).toEqual({});
  });

  it("R-01: rejects batteryEnd equal to batteryStart", () => {
  ...
  it("R-01: rejects batteryEnd greater than batteryStart", () => {
  ...
  it("R-01: rejects batteryStart outside 0 to 100", () => {
  ...
  it("R-01: accepts null batteryEnd before completion", () => {
    const errors = validateBattery(80, null);

    expect(errors).toEqual({});
  });

  it("R-02: accepts duration of 1 minute", () => {
    const errors = validateDuration(1);

    expect(errors).toEqual({});
  });

  it("R-02: accepts duration of 120 minutes", () => {
    const errors = validateDuration(120);

    expect(errors).toEqual({});
  });

  it("R-02: rejects duration of 0", () => {
  ...
  it("R-02: rejects duration above 120", () => {
  ...
  it("R-02: rejects decimal duration", () => {
...
describe("Mission Rules - R-04", () => {
  ...
  it("R-04: rejects a mission that overlaps at the beginning", () => {
    const mission = {
      id: "mission-002",
      pilotId: "pilot-001",
  ...
  it("R-04: rejects a mission that overlaps at the end", () => {
    const mission = {
      id: "mission-002",
      pilotId: "pilot-001",
  ...
  it("R-04: rejects a mission completely inside another mission", () => {
    const mission = {
      id: "mission-002",
      pilotId: "pilot-001",
  ...
  it("R-04: allows missions that meet exactly at the boundary", () => {
    const mission = {
      id: "mission-002",
      pilotId: "pilot-001",
  ...
  it("R-04: allows missions for different pilots at the same time", () => {
    const mission = {
      id: "mission-002",
      pilotId: "pilot-002",
      scheduledAt: "2026-09-02T10:30:00Z",
  ...
  it("R-04: excludes the mission being edited from the overlap check", () => {
    const mission = {
      id: "mission-001",
      pilotId: "pilot-001",
      scheduledAt: "2026-09-02T10:00:00Z",
...
describe("Mission Rules - R-05", () => {
  it("R-05: accepts an active pilot", () => {
    const pilot = {
      id: "pilot-001",
      isActive: true,
    };
  ...
  it("R-05: rejects an inactive pilot", () => {
    const pilot = {
      id: "pilot-002",
      isActive: false,
    };
  ...
  it("R-05: does not reject an active pilot even when assigning a new mission", () => {
    const pilot = {
      id: "pilot-003",
      isActive: true,
    };
...
describe("Mission Rules - R-06", () => {
  it("R-06: allows planned to in_progress", () => {
  ...
  it("R-06: allows planned to aborted", () => {
    const errors = validateStatusTransition(
      "planned",
      "aborted",
    );
  ...
  it("R-06: allows in_progress to completed", () => {
    const errors = validateStatusTransition(
      "in_progress",
      "completed",
    );
  ...
  it("R-06: allows in_progress to aborted", () => {
    const errors = validateStatusTransition(
      "in_progress",
      "aborted",
    );
  ...
  it("R-06: rejects planned to completed", () => {
    const errors = validateStatusTransition(
      "planned",
      "completed",
    );
  ...
  it("R-06: rejects changes from completed", () => {
    const errors = validateStatusTransition(
      "completed",
      "in_progress",
    );
  ...
  it("R-06: rejects changes from aborted", () => {
    const errors = validateStatusTransition(
      "aborted",
      "in_progress",
    );
...
describe("Mission Rules - R-07", () => {
  it("R-07: accepts an abort reason with exactly 10 characters", () => {
    const notes = "1234567890";

    expect(notes.trim().length).toBeGreaterThanOrEqual(10);
  });

  it("R-07: accepts an abort reason longer than 10 characters", () => {
    const notes = "Mission aborted because of bad weather";

    expect(notes.trim().length).toBeGreaterThanOrEqual(10);
  });

  it("R-07: rejects an abort reason shorter than 10 characters", () => {
    const notes = "Too short";

    expect(notes.trim().length).toBeLessThan(10);
  });

  it("R-07: rejects a missing abort reason", () => {
